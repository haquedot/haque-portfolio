export const projectsData = [
  ...
  },
  {
    ...
    description:
      "A premier global event platform for discussing Environmental, Social, and Governance (ESG) initiatives and sustainable business practices.",
    image: "/worldesgsummit.webp",
    tags: ["HTML", "CSS", "Bootstrap", "JavaScript", "jQuery", "Responsive Design"],
    demoUrl: "https://worldesgsummit.com/",
    githubUrl: "",
    features: [
      "Event information and registration",
      "Speaker profiles and agenda",
      "Responsive design for all devices",
      "Information about ESG initiatives",
    ],
  },
  {
